...
use crate::finite_volume::{boundary::BoundaryCondition, config::CaseConfig, equation::{Component, EquationSolver, variables::{ControlVolumeType, Variable}}, fields::Field};
                ...
                match bc {
                    BoundaryCondition::Dirichlet(bc_value) => {
                        ...
                        for cv in &bnd.nodes()[i_bnd] {
                            ...
                            match row.get_entry_mut(*cv).expect("Bad Initialization of matrix") {
